...
var ModuleWatcher = function(baseGitRepoPath, options) {
...
ModuleWatcher.prototype.close = function() {
	var me = this;
	log('Closing module: ' + me.path);
	me.fsWatchers.members.forEach(function(watcher) {
		watcher.close();
	});
};
...
ModuleWatcher.prototype._buildLines = function(lineChunks, oldLines, newLines) {
	var me = this;
	var lines = [], contextLines = me.options.diff.contextLines || 3;
