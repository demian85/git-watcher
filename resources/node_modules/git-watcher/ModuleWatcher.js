...
ModuleWatcher.prototype._buildRanges = function(chunks, contents) {
	...
	if (chunks.length > 0) {
		...
		for (var i = 0; i < chunks.length-1; i++) {
			...
			var diff = chunks[i+1].line - chunks[i].line;
			if (diff <= contextLines*2) {
				add(chunks[i].line, chunks[i].line + diff - 1);
			} else {
				add(chunks[i].line, chunks[i].line + contextLines);
