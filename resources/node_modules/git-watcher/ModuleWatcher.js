...
ModuleWatcher.prototype._buildLines = function(lineChunks, oldLines, newLines) {
	...
	if (lineChunks.length > 0) {
		var firstRangeStart = getRangeStart(lineChunks[0]);
		addContextLines(firstRangeStart - contextLines, firstRangeStart);
		...
		if (lineChunks.length > 1) {
			...
			var lastRangeEnd = getRangeStart(lineChunks[lineChunks.length-1]) + lineChunks[lineChunks.length-1].new.lines;
			addContextLines(lastRangeEnd, lastRangeEnd + contextLines);
		}
	}
