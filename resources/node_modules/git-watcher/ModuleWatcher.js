...
ModuleWatcher.prototype._getFileDiff = function(filePath, isStaged, type, callback) {
	...
	var lineChunks = diff.map(function(change) {
		...
		//if (oldMin <= newMin) {
			...
			var chunks = me._getRangeDiff('-', oldRange).concat(me._getRangeDiff('+', newRange));
		/*} else {
			chunks = me._getRangeDiff('+', newRange).concat(me._getRangeDiff('-', oldRange));
		}*/
		return chunks;
	});
	callback(null, lineChunks); // TODO: async
};
