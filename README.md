...
* Linux x64 - __Old dists__: Ubuntu 12.04, 12.10 or derivative distributions
	* [v0.4](https://bitbucket.org/demian85/git-watcher/downloads/gitw-linux-x64-0.4.tar.gz)
...
* Linux x64 - __New dists__: Ubuntu 13.04+, Gentoo, Arch, Fedora 18+
	* [v0.4](https://bitbucket.org/demian85/git-watcher/downloads/gitw-linux-x64-v0.4-new-dist.tar.gz)
